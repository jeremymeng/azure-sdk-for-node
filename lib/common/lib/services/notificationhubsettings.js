...
/**
* Creates new notification hub settings instance.
*
...
*/
function NotificationHubSettings(serviceBusEndpointUri, wrapEndpointUri, namespace, wrapName, wrapPassword, sharedAccessKeyName, sharedAccessKey) {
...
/**
* Creates a NotificationHubSettings object from a set of settings.
*
* @param {object} settings The settings object.
*
* @return {NotificationHubSettings}
*/
NotificationHubSettings.createFromSettings = function (settings) {
  ...
  if (matchedSpecs) {
    ...
    return new NotificationHubSettings(
      endpoint,
      wrapEndpoint,
      namespace,
      issuerName,
...
/**
* Creates a NotificationHubSettings object from the given connection string.
*
* @param {string} connectionString The storage settings connection string.
*
* @return {NotificationHubSettings}
*/
NotificationHubSettings.createFromConnectionString = function (connectionString) {
  var tokenizedSettings = ServiceSettings.parseAndValidateKeys(connectionString, validKeys);
  try {
    return NotificationHubSettings.createFromSettings(tokenizedSettings);
  } catch (e) {
...
/**
* Create a NotificationHubSettings object from the given configuration
*
...
NotificationHubSettings.createFromConfig = function (config) {
  if (!config) {
  ...
  if (config.has(configKeys.CONNECTION_STRING)) {
    ...
    return NotificationHubSettings.createFromSettings(createSettingsFromEnvironment());
  }

  if (connectionString) {
    return NotificationHubSettings.createFromConnectionString(connectionString);
  }
...
*/
NotificationHubSettings.customizeConfig = function (config) {
...
module.exports = NotificationHubSettings;
