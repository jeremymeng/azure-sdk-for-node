...
var NotificationHubManagementService = require('./notificationhubmanagementservice');
exports.NotificationHubManagementService = NotificationHubManagementService;

/**
* Notification Hub Management client exports.
* @ignore
*/

/**
* Creates a new {@link NotificationHubManagementService} object.
*
...
* @return {NotificationHubManagementService}                    A new NotificationHubManagementService object.
*/
exports.createNotificationHubManagementService = function (configOrNamespaceOrConnectionString, accessKey, issuer, acsNamespace, host, authenticationProvider) {
  return new NotificationHubManagementService(configOrNamespaceOrConnectionString, accessKey, issuer, acsNamespace, host, authenticationProvider);
};
